...
\begin{figure}
\subfloat[Magnitud del viento (m/s) \label{dif-spd}\label{fig:diferencia1}]{\includegraphics{Defensa/Fig/diferencia-1} }\subfloat[Ángulo de la dirección del viento (grados) \label{dif-dir}\label{fig:diferencia2}]{\includegraphics{Defensa/Fig/diferencia-2} }\caption{Diferencia entre las observaciones y cada simulación para la magnitud del viento (m/s) (a) y el ángulo de la dirección del viento (grados) (b) correspondiente al Caso 1. \label{dif}}\label{fig:diferencia}
\end{figure}
