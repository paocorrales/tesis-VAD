...
Altura de la clp con reflectividad. Ver ese dobe tope durante el día y la noche (tope de la capa residual?). Ver que hay de interesante en cada caso.
...
La altura de la capa límite se empalma con las caractersíticas turbulentas, acá no tengo mucho pero puedo usar el número de Richardson, la cortante y la comparación con la otra forma de estimar la altura de la CLP.
...
Ekman, ojo que hay que tener en cuenta la altura de la clp, por arriba no vale. 
