...
```{r estable-vad, fig.cap="Series de tiempo de algunas característicad de la capa estable nocturna para todos los casos. \\label{estable-vad}", fig.subcap=c("Altura de la capa estable \\label{h-vad}", "Cortante (u\\_max/z\\_max) \\label{cortante-vad}", "Número de Richardson \\label{ri}"), fig.ncol=1, fig.height=0.28*text.height}
