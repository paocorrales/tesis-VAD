...
kable(tmp, digits = 4, caption = "Errores calculados para las distintas pruebas de validación.")
```
...
kable(param, format = "latex", booktabs = T, caption = "Parámetros utilizados en el cálculo del VAD y la construcción de la grilla vertical para todos los casos") %>% 
  collapse_rows(1)
```
...
```{r campo-caso1, fig.cap="Magnitud del viento y dirección correspondiente al Caso 1 (14/01/2016) obtenidas procesados con VAD \\label{campo-caso1}", fig.subcap=c("Magnitud del viento. \\label{caso1-spd}", "Dirección. \\label{caso1-dir}"), out.width="0.98\\textwidth", fig.height=0.4*text.height, fig.ncol=1}
...
```{r campo-caso2, fig.cap="Magnitud del viento y dirección correspondiente al Caso 2 (21/01/2016) obtenidas procesados con VAD \\label{campo-caso1}", fig.subcap=c("Magnitud del viento. \\label{caso2-spd}", "Dirección. \\label{caso2-dir}"), out.width="0.98\\textwidth", fig.height=0.4*text.height, fig.ncol=1}
...
```{r campo-caso3, fig.cap="Magnitud del viento y dirección correspondiente al Caso 3 (23/01/2016) obtenidas procesados con VAD \\label{campo-caso3}", fig.subcap=c("Magnitud del viento. \\label{caso1-spd}", "Dirección. \\label{caso3-dir}"), out.width="0.98\\textwidth", fig.height=0.4*text.height, fig.ncol=1}
...
ggplot(gdata, aes(ht, spd_smooth, color = as.factor(hour(date_time)))) +
  ...
  coord_flip() +
  scale_color_viridis(name="Hora UTC", discrete = T) + 
...
<!-- Ri vs time + umáx/zmáx vs time + pblh en la capa estable  -->
<!-- Honografas en altura día/noche  -> Ekman -->
...
#### Oscilación inercial
<!-- Hodografas a lo largo del tiempo -> osiclación inercial -->
