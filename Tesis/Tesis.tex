...
\begin{figure}
\subfloat[Altura de la capa estable \label{h-vad}\label{fig:estable-vad1}]{\includegraphics{Tesis_files/figure-latex/estable-vad-1} }\newline\subfloat[Cortante (u\_max/z\_max) \label{cortante-vad}\label{fig:estable-vad2}]{\includegraphics{Tesis_files/figure-latex/estable-vad-2} }\newline\subfloat[Número de Richardson \label{ri}\label{fig:estable-vad3}]{\includegraphics{Tesis_files/figure-latex/estable-vad-3} }\caption{Series de tiempo de algunas característicad de la capa estable nocturna para todos los casos. \label{estable-vad}}\label{fig:estable-vad}
\end{figure}
...
\includegraphics{Tesis_files/figure-latex/unnamed-chunk-1-2.pdf}

Campos (mag) + diferencia Algo para la dirección, tal vez lo mismo
Perfiles \#\#\# Características de la capa límite L Oscilacion inercial
\#\#\#\# Altura de la capa límite Comparación entre simulaciones y
observaciones Gráfico de dispersión para analizar la altura obtenida con
umax \#\#\#\# Coeficientes de difusividad turbulenta \# Conclusiones
