...
de suponer válida la teoría K (Pasquill, 2007) y que los coeficientes de
intercambio turbulento de calor sensible y de cantidad de movimiento son
iguales, es posible escribir el número de Richardson en función de los
gradientes verticales de viento y temperatura potencial:
...
{\centering \includegraphics{Tesis_files/figure-latex/pblh-dbz-1} 

}

\caption{Valor absoluto del gradiente vertical de dBZ en función de la altura y el tiempo para el Caso 1. \label{pblh-dbz}}\label{fig:pblh-dbz}
\end{figure}
...
\midrule
YSU & -0.8484 & 2.3088 & 2.1254 & 0.6814 & 6.6014 & 76.8080 & 76.4990 & -0.2343\\
MYJ & -0.5639 & 2.5587 & 2.4851 & 0.6332 & 2.4440 & 76.2882 & 76.2449 & -0.2720\\
ACM2 & -1.0089 & 2.3356 & 2.0733 & 0.7112 & 8.2172 & 75.8846 & 75.3991 & -0.2124\\
\bottomrule
\end{tabular}
\end{table}
...
\subsubsection{Altura de la capa
límite}\label{altura-de-la-capa-limite-2}

\begin{figure}

{\centering \subfloat[Estimada directamente por cada esquema de CLP. \label{pblh}\label{fig:pblh-wrf1}]{\includegraphics{Tesis_files/figure-latex/pblh-wrf-1} }\newline\subfloat[Comparación entre la altura calculada por cada esquema y la estimada a partir de la altura del viento máximo (sólo período estable). \label{pblh-spd}\label{fig:pblh-wrf2}]{\includegraphics{Tesis_files/figure-latex/pblh-wrf-2} }
...
Pasquill, 2007. Atmospheric Diffusion, John Wiley \& Sons, New York,
Vol. 2, pp. 50-58.
