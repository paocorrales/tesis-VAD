...
elegidas en el Caso 1 se compararos las distintas simulaciones con las
...
el bias (o sesgo), rmse, rmsens (raíz del error cuadratico medio debido
...
calmo y verticalmente homogeneo en las horas diurnas.
...
viento ocurre en dintintos niveles en casa caso. En niveles altos, el
...
muestra el valor absoluto de la diferencia entre el ángulo del vecto del
viento observado y el simulado. En las tres simulaciones la mayor
