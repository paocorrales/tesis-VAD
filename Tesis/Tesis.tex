...
\begin{figure}
\subfloat[Magnitud del viento. \label{caso1-spd}\label{fig:campo-caso11}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso1-1} }\newline\subfloat[Dirección. \label{caso1-dir}\label{fig:campo-caso12}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso1-2} }\caption{Magnitud del viento y dirección correspondiente al Caso 1 (14/01/2016) observados por el radar y procesados con VAD \label{campo-caso1}}\label{fig:campo-caso1}
\end{figure}

\begin{figure}
\subfloat[Magnitud del viento. \label{caso2-spd}\label{fig:campo-caso21}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso2-1} }\newline\subfloat[Dirección. \label{caso2-dir}\label{fig:campo-caso22}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso2-2} }\caption{Magnitud del viento y dirección correspondiente al Caso 2 (21/01/2016) observados por el radar y procesados con VAD \label{campo-caso2}}\label{fig:campo-caso2}
\end{figure}

\begin{figure}
\subfloat[Magnitud del viento. \label{caso3-spd}\label{fig:campo-caso31}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso3-1} }\newline\subfloat[Dirección. \label{caso3-dir}\label{fig:campo-caso32}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso3-2} }\caption{Magnitud del viento y dirección correspondiente al Caso 3 (23/01/2016) observados por el radar y procesados con VAD \label{campo-caso3}}\label{fig:campo-caso3}
\end{figure}
...
\caption{Perfil de viento observado por el radar a las 0600 y las 1700 UTC y el $rmse_2$ calculado en sombreado para cada caso. El valor en superficie corresponde a lo observado por la estación meteorógica. \label{perfiles-horarios}}\label{fig:perfiles}
\end{figure}
...
\caption{Variación del vector del viento en función de la altura entre 100 y 3000 metros, para cada caso de estudio observada por el radar a las 0600 UTC. El triángulo marca el nivel inferior (z = 100 m) \label{hodografa-h}}\label{fig:hodografa-horaria}
\end{figure}
...
{\centering \includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/vad-modelo-spd-1} 

}

\caption{Magnitud del viento observada por el radar y simulada utilizando distintas parametrizaciones para el Caso 1 (14/01/2016) y posteriormente procesados con VAD \label{modelo-spd}}\label{fig:vad-modelo-spd}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/vad-modelo-dir-1} 

}

\caption{Dirección del viento observada por el radar y simulada utilizando distintas parametrizaciones para el Caso 1 (14/01/2016) y posteriormente procesados con VAD. \label{modelo-dir}}\label{fig:vad-modelo-dir}
\end{figure}

\begin{figure}
\subfloat[Magnitud del viento \label{dif-spd}\label{fig:diferencia1}]{\includegraphics{Tesis_files/figure-latex/diferencia-1} }\subfloat[Dirección del viento \label{dif-dir}\label{fig:diferencia2}]{\includegraphics{Tesis_files/figure-latex/diferencia-2} }\caption{diferencia \label{dif}}\label{fig:diferencia}
\end{figure}

Perfiles \#\#\# Estructura de la capa límite
...
importante ya que el signo de L debe manetenerte positivo para el
regimen estable y negativo para el regimen inestable a lo largo del
dominio.

Sin embargo se observa que esto no ocurre y que existen regiones donde
el signo de L es más 40\% de las veces distinto a la moda del dominio.
Esto puede estar relacionado la variación en la altura del terreno o a
la presencia del río y zonas con suelos saturados donde los flujos
verticales de calor (\(f_{\theta}\)) tengan un comportamiento contrario
al suelo seco.

\textbackslash{}begin\{figure\}
\includegraphics[width=0.48\textwidth]{Tesis_files/figure-latex/L-espacial-1}
\textbackslash{}caption\{Porcentaje de veces que el valor local de L (a)
y el flujo vertical de calor (b) tiene signo distinto a la moda para
todo el periodo analizado, se muestran los valores mayores al 5\%
(colores) y topografía del dominio (contornos). Simulación con la
parametrización YSU. \label{L-esp}\}\label{fig:L-espacial}
\textbackslash{}end\{figure\} Entonces nos quedamos con el análsis en un
punto cercano al radar que además no presenta gran variabilidad respecto
de la región circundante.

\begin{figure}

{\centering \includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/L-parm-1} 

}

\caption{Longitud de Monin Obukhov (m) en función del tiempo y para cada parametrización. \label{L-param}}\label{fig:L-parm}
\end{figure}

\begin{figure}
\centering
\includegraphics{Tesis_files/figure-latex/kh_wrf-1.pdf}
\caption{Coeficiente de difusividad de calor Kh (m-2 s-1) promediado
sobre el regimen estable (izquierda) y el regimen inestable (derecha) de
la capa límite para los distintos esquemas analizados.}
\end{figure}
...
la altura obtenida con umax \#\#\#\# Coeficientes de difusividad
turbulenta

\begin{figure}
\centering
\includegraphics{Tesis_files/figure-latex/kh_ulke-1.pdf}
\caption{Coeficiente de difusividad de calor Kh (m-2 s-1) promediado
sobre el regimen estable (izquierda) y el regimen inestable (derecha) de
la capa límite para los distintos esquemas analizados.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Tesis_files/figure-latex/kh_norm-1.pdf}
\caption{Coeficiente de difusividad de calor Kh* = Kh/khu* promediado
sobre el regimen estable (izquierda) y el regimen inestable (derecha) de
la capa límite para los distintos esquemas analizados.}
\end{figure}

\includegraphics{Tesis_files/figure-latex/unnamed-chunk-3-1.pdf}

\begin{longtable}[]{@{}llrrrrr@{}}
\toprule
param & regimen & h\_norm & L\_norm & ust\_norm & Pr & hL\tabularnewline
\midrule
\endhead
YSU & estable & 368.6713 & 45.30290 & 0.2911110 & 1.3278002 &
8.137918\tabularnewline
YSU & inestable & 1563.1427 & -35.07287 & 0.6019572 & 0.2595942 &
-44.568430\tabularnewline
MYJ & estable & 273.6321 & 84.66978 & 0.3134422 & 1.3240502 &
3.231757\tabularnewline
MYJ & inestable & 1569.4922 & -95.79171 & 0.6198216 & 0.3381030 &
-16.384425\tabularnewline
ACM2 & estable & 199.3203 & 45.30290 & 0.2696756 & 1.3278002 &
4.399725\tabularnewline
ACM2 & inestable & 1871.8766 & -35.07287 & 0.6054872 & 0.2595942 &
-53.371071\tabularnewline
\bottomrule
\end{longtable}

\includegraphics{Tesis_files/figure-latex/unnamed-chunk-5-1.pdf}
