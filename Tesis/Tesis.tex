...
\begin{figure}
\subfloat[Magnitud del viento. \label{caso1-spd}\label{fig:campo-caso11}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso1-1} }\newline\subfloat[Dirección. \label{caso1-dir}\label{fig:campo-caso12}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso1-2} }\caption{Magnitud del viento y dirección correspondiente al Caso 1 (14/01/2016) obtenidas procesados con VAD \label{campo-caso1}}\label{fig:campo-caso1}
\end{figure}

\begin{figure}
\subfloat[Magnitud del viento. \label{caso2-spd}\label{fig:campo-caso21}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso2-1} }\newline\subfloat[Dirección. \label{caso2-dir}\label{fig:campo-caso22}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso2-2} }\caption{Magnitud del viento y dirección correspondiente al Caso 2 (21/01/2016) obtenidas procesados con VAD \label{campo-caso1}}\label{fig:campo-caso2}
\end{figure}

\begin{figure}
\subfloat[Magnitud del viento. \label{caso1-spd}\label{fig:campo-caso31}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso3-1} }\newline\subfloat[Dirección. \label{caso3-dir}\label{fig:campo-caso32}]{\includegraphics[width=0.98\textwidth]{Tesis_files/figure-latex/campo-caso3-2} }\caption{Magnitud del viento y dirección correspondiente al Caso 3 (23/01/2016) obtenidas procesados con VAD \label{campo-caso3}}\label{fig:campo-caso3}
\end{figure}

\begin{figure}
\centering
\includegraphics{Tesis_files/figure-latex/perfiles-1.pdf}
\caption{COMPLETAR}
\end{figure}
