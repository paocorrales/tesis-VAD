...
angmax = 11       #Ángulo de elevación máximo expresado como indice
...
for f in range(len(FileList)):
    ...
    vad.to_csv('../../caso1acm_240/elev_vad-'+ DateTime + '_' + NameRadar + '.csv', sep = ';', na_rep = '-9999')
...
for f in range(len(FileList)):
    ...
    totalvad = pandas.DataFrame(np.zeros(shape=(int(pnlevs),7))*np.nan, columns = ['ht', 'spd', 'rmse1', 'rmse2', 'di', 'rings'])
    ...
    totalvad.to_csv('../../caso1acm_240/'+ file[5:], sep = ';', na_rep = '-9999')
